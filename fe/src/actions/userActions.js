...
export const getAllUsers = () => async (dispatch) => {
        ...
        const { data } = await axios.get(`http://127.0.0.1:5000/api/v1/admin/users`);
    ...
    export const getUserDetails = (id) => async (dispatch) => {
        ...
        const { data } = await axios.get(`http://127.0.0.1:5000/api/v1/admin/user/${id}`);
...
export const updateUser = (id, userData) => async (dispatch) => {
    ...
    export const deleteUser = (id) => async (dispatch) => {
        ...
        const { data } = await axios.delete(`http://127.0.0.1:5000/api/v1/admin/user/${id}`);
