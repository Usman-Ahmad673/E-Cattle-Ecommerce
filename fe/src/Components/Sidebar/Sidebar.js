...
const Sidebar = () => {
    ...
    // const { error, loading , isAuthenticated} = useSelector((state) => state.userLogout);
    ...
    const headerItems = [
        { icon: HomeIcon, name: 'Home', func : adminDashboard },
        { icon: ListAltIcon, name: 'Cattle / Doctor List', func : doctorCattleList },
        // { icon: ListAltIcon, name: 'Cattle / Doctor List', to: '/cattle' },
        { icon: AddBoxIcon, name: 'Add Cattle', func : addCattle },
        { icon: AddBoxIcon, name: 'Add Doctor', func : addDoctor },
        { icon: DashboardIcon, name: 'Dashboard', func : doctorDashboard },
        { icon: UploadIcon, name: 'Add Product', func : ecommerce },
        ...
        <React.Fragment>
            <Grid container-fluid="true" justifyContent='center'>
                <Grid item xs={10} sm={8} md={6}>
                    <AppBar position="static" sx={{ bgcolor: 'rgb(2,0,36)', background: 'linear-gradient(354deg, rgba(2,0,36,0.7399334733893557) 0%, rgba(83,205,38,1) 55%, rgba(255,255,255,1) 100%)'}}>
                        <Toolbar>
