        ...
        return (
            <React.Fragment>
                <Grid item xs={12} md={6} lg={4}>
                    <Typography variant="h5" color='red'>Cattle ID: {cattle._id}</Typography>
                    
                    <Typography variant="h6" color='green'>Medicines:</Typography>
                    ...
                    <Typography variant="h6" color='green'>Injections:</Typography>
                    ...
                    <Typography variant="h6" color='green'>Diseases:</Typography>
                    ...
                    <Typography variant="h6" color='green'>Add Medicine:</Typography>
                        <Grid item>
                        <TextField
                            // fullWidth
                            name="name"
                        ...
                        />
                            <Button sx={{width:'4rem' , padding:'0.9rem'}} variant="contained" onClick={handleAddMedicine}>
                            Add
                            </Button>
                        </Grid>
                        <Typography variant="h6" color='green'>Add Injection:</Typography>
                        <Grid item>
                        <TextField
                            // fullWidth
                            name="name"
                        ...
                        />
                            <Button sx={{width:'4rem' , padding:'0.9rem'}} variant="contained" onClick={handleAddInjection}>
                            Add
                            </Button>
                        </Grid>
                        <Typography variant="h6" color='green'>Add Disease:</Typography>
                        <Grid item>
                            <TextField
                                // fullWidth
                                name="name"
                            ...
                            />
                            <Button sx={{width:'4rem' , padding:'0.9rem'}} variant="contained" onClick={handleAddDisease}>
                            Add
                            </Button>
                        </Grid>
                    <Button sx={{marginTop:'2rem'}} variant="text" onClick={() => handleUpdateCattle(cattle._id)}>
                    Update Cattle
                    </Button>
                    <hr />
                </Grid>
